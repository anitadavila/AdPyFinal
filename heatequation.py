...
fig = plt.figure()
fig.set_dpi(100) #this sets the size fit screen
ax1 = fig.add_subplot(1,1,1) #sets the location and size on the screen
...
#Increment
dt = 0.01 #orginally 0.01 and this is change of time how slow time is going
